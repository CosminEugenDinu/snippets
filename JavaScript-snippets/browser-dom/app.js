...
const menu = new Menu('Web App', { shapes, about },
    e => {
...
function shapes(e) {
    ...
    const shapesMenu = new Menu('Add shape', {
...
function libraryGet(required) {
    ...
    class Menu extends Element {
        constructor(textMsg, items, onClose) {
            ...
            const header = new Wrap()
                .setStyle({ backgroundColor: '#fafafa' });
            const body = new Wrap().createElement();
    ...
    class Page extends Element {
        constructor(title, content, onClose) {
            ...
            const header = new Wrap();
            const titleElem = new Element('h3', title)
                .setStyle({ width: '100%', textAlign: 'center' });
            const closeBtn = new Button('x')
                .setOnClick(e => {
                    onClose(e);
            ...
            header.setChildren([titleElem.createElement(),
