...
short num_bit10[4] = {1023, 1022, 1021, 1020};
...
int main()
{
    ...
    num[0] = num[0] < 0 ? 1024 + num[0]: num[0]; 
    num[1] = num[1] < 0 ? 1024 + num[1]: num[1]; 
    num[2] = num[2] < 0 ? 1024 + num[2]: num[2]; 
    num[3] = num[3] < 0 ? 1024 + num[3]: num[3]; 
